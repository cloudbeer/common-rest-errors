...
var errors = {
    //validate error
    CUSTOM: function (msg = "未知错误。") {
        return YError(msg, -1);
    },
    WHAT_REQUIRE: function (what) {
        return YError("需要参数：" + what + "。", -1001);
    },
    WHAT_WRONG_RANGE: function (what = '参数', min = null, max = null) {
        var msg = what + "取值范围错误。";
        if (min != null) {
            msg += "，最小值 " + min;
        }
